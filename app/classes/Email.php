    ...
    //    $auth = $env['auth'] ?? false;
        ...
        try {
            ...
            // $mail->Port       = 587;     
              ...
              // Verifica se $email é um array ou uma string
        ...
        foreach ($recipients as $recipient) {
            ...
            $mail->addAddress($recipient, 'Admin Lucas');    
            $mail->send();
            
            // Limpa o destinatário para o próximo e-mail
            $mail->clearAddresses();
        }
            ...
            // $l= new CreateLogger();
            // $l->loggerCSV("Erro_envio_email","{$mail->ErrorInfo}");
