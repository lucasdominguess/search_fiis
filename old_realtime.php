...
foreach ($tickets as $ticket) {
    ...
    file_put_contents("$ticket[0].csv", json_encode($data)); //objetivo salvar o preço atual para depois ler e comparar se subiu ou caiu dependendo do preço anterior
